...
connection_create <- function(host, user, password, db, port, unix_socket, client_flag, group, default_file, ssl_key, ssl_cert, ssl_ca, ssl_capath, ssl_cipher, timeout) {
    .Call(`_RMariaDB_connection_create`, host, user, password, db, port, unix_socket, client_flag, group, default_file, ssl_key, ssl_cert, ssl_ca, ssl_capath, ssl_cipher, timeout)
}
